...
//		HashMap carrosPopulares2020 = new HashMap();
//		Map<String, Double> carrosPopulares = new HashMap<>(); //Recomendado
//		HashMap<String, Double> carrosPopulares = new HashMap<>(); 
//		Map<String, Double> carrosPopulares2020 = Map.of("gol", 14.4, "uno", 15.6, "mobi", 16.1, "hb20", 14.5, "kwid", 15.6) //Recomendado
		...
		Map<String, Double> carrosPopulares = new HashMap<>() {
			{
				//As chaves(modelo) precisam ser de valor �nico, os valores(consumo) podem ser duplicados
				put("gol", 14.4);
				put("uno", 15.6);
				put("mobi", 16.1);
				put("hb20", 14.5);
...
//		System.out.println("Exiba o terceiro modelo adicionado: ");
		...
		Double consumoMaisEficiente = Collections.max(carrosPopulares.values()); //Obtem o maior valor de km/l
		Set<Map.Entry<String, Double>> entries = carrosPopulares.entrySet(); //Cria um Set igualando todas as chaves ao valor
		String modeloMaisEficiente = "";
		for (Map.Entry<String, Double> entry : entries) {
			if (entry.getValue().equals(consumoMaisEficiente)) { //getValue() pega o valor
				modeloMaisEficiente = entry.getKey();            //getKey() pega a chave
